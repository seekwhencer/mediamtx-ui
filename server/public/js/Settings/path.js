...
export default class PathSettings extends Setting {
    constructor(settings) {
        ...
        this.options = {
            ...
            rpiCameraBrightness: {min: -1, max: 1, step: '0.1'},
            rpiCameraContrast: {min: 0, max: 16, step: '1'},
            rpiCameraSaturation: {min: 0, max: 16, step: '1'},
            rpiCameraSharpness: {min: 0, max: 16, step: '1'},
            ...
            rpiCameraEV: {min: -10, max: 10, step: '1'},
